...
interface Parametro {
  key: keyof Pick<Configuracion, 'duracionMaximaVisita' | 'visitantesPorDia' | 'visitantesPorRecluso' | 'tiempoAdvertencia'>;
  label: string;
  descripcion: string;
  valor: number;
  unidad: string;
  ...
  private cargarParametros(): void {
    ...
    this.parametros = [
      ...
      },
      {
        ...
        descripcion: 'Máximo de visitantes permitidos por visita',
